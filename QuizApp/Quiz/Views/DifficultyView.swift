...
class DifficultyStackView: UIStackView {
    ...
    func setDifficulty(type: DifficultyModel) {
        ...
        case .easy:
            ...
            difficultyView2.backgroundColor = emptyFillColor
            difficultyView3.backgroundColor = emptyFillColor
        case .normal:
            difficultyView1.backgroundColor = .yellow
...
extension DifficultyStackView: ConstructViewsProtocol {
    ...
    func defineLayoutForViews() {
        difficultyView1.snp.makeConstraints {
            $0.width.equalTo(rectangleConstant)
            $0.height.equalTo(rectangleConstant)
        }
